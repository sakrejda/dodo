load_get_compare_K <- function(times_of_surveys, times_of_recaptures) {
	ptr <- state_wrapper(times_of_surveys, times_of_recaptures)
...
load_get_compare_deaths <- function(times_of_surveys, times_of_recaptures) {
	ptr <- state_wrapper(times_of_surveys, times_of_recaptures)
	original_deaths <- sapply( times_of_recaptures, max )
	returned_deaths <- as.vector(get_deaths(ptr))
